      ...
      <div class="hero-info">
        <div class="profile-info">
          <div class="avatar-wrapper">
            <img :src="iconUrl" alt="个人头像" class="my-avatar" />
          </div>
        ...
        <!-- <el-divider class="hero-skill-divider"> 个人技能 </el-divider> -->

        <div class="skills-section">
          <div
            v-for="(group, index) in skillList"
            :key="index"
            class="skill-group"
          >
      ...
      <div class="typewriter-box">
        <div class="content-card content-card-advantage">
          ...
          <ul class="advantage-list">
            <li>
              <strong>3年工业数字化前端深耕：</strong>
              具备独立负责大型项目全流程开发能力，注重交付质量。
            </li>
            <li>
              <strong>前沿可视化/3D扎实：</strong>
              熟练使用ECharts、DataV，熟练掌握 Three.js
              数字孪生厂区交互与坐标转换。
            </li>
            <li>
              <strong>跨端与硬件交互：</strong> 熟练运用 UniApp
              进行多端开发，具备 NFC、语音播报等工业级硬件对接经验；熟悉React
              Native(app端)开发。
            </li>
            <li>
              <strong>极强自驱与无断层自学：</strong> 离职期间高标准自学
              Vue3+TS+Vite 生态，并有完整大屏 Demo 产出。
            </li>
            <li>
              <strong>团队赋能：</strong>
              具备良好的代码规范意识，善于封装高复用业务组件，提升团队迭代效率。
            </li>
          </ul>
        </div>
        <div class="content-card content-card-experience">
          ...
          <div class="timeline">
            <div class="timeline-item">
              ...
              <div class="timeline-body">
                <p class="project-name">
                  <strong>核心项目：</strong>安全管控一体化平台 (Web端 / 移动端
                  / UniApp)
                </p>
                <p class="project-desc">
                  <strong>项目简介：</strong
                  >面向电力及工业场景，集成智能巡检、电子工作票、智能锁控、安防监控为一体的综合数字化安全管理系统。
                </p>
                <ul class="achievement-list">
                  <li>
                    <strong>架构与性能优化：</strong
                    >参与并主导前端可视化部分核心架构搭建与选型（Vue2/3+ElementUI），大幅提升首屏加载速度。
                  </li>
                  <li>
                    <strong>3D数字孪生：</strong>利用
                    <strong>Three.js</strong> 定制 3D 智慧厂区，攻克了外部大体积
                    .gltf 模型的动态加载与多层级坐标转换难题；利用
                    Raycaster（光线投射）原理 完美实现 3D
                    空间内电力设备的精准点击交互与数据下钻。
                  </li>
                  <li>
                    <strong>数据可视化：</strong>独立负责大屏模块，基于
                    ECharts/DataV
                    深度定制多类动态图表，独立负责安全管控平台大屏模块。针对多数据引发的卡顿问题，引入防抖机制，配合组件销毁时的实例释放，
                    成功消除内存泄漏，首屏加载速度大幅度提升。
                  </li>
                  <li>
                    <strong>移动端与硬件交互：</strong>基于 UniApp
                    复刻巡检模块app功能，集成
                    NFC标签识别、离线语音播报等特种作业功能。
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="timeline-item">
              <div class="timeline-dot"></div>
              <div class="timeline-header">
                <span class="time-range">2025.06 - 2025.11</span>
                <span class="company">澳门江门同乡会</span>
                <span class="role">新媒体运营（兼职/视觉赋能）</span>
              </div>
              <div class="timeline-body">
                <p class="project-desc">
                  负责数字化活动视觉策划、短视频剪辑及公众号矩阵宣发。保持良好职场节奏，跨界锻炼了优秀的视觉审美与排版布局能力。
                </p>
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-body">
                <p class="project-desc">
                  全面采用
                  <strong
                    >Vue3 Composition API + TypeScript + Vite + Pinia</strong
                  >
                  重构并独立设计了一套全新的电力可视化全景看板系统，确保自身技术栈与一线无缝衔接。无技术断层，具备即战力。
                </p>
              </div>
            </div>
          </div>
...
const iconUrl = new URL("@/assets/images/avatar.jpg", import.meta.url).href;

const skillList = ref([
  {
    title: "🌐 前端开发",
    tags: ["Vue2", "Vue3", "JavaScript", "ElementUI", "HTML5", "TypeScript"],
  },
  {
    title: "📊 可视化 / 3D",
    tags: ["ECharts", "DataV", "shturl.c"],
  },
  {
    title: "📱 跨端开发",
    tags: ["UniApp", "React Native(app端)", "Java", "Android Studio","MySQL","Node.js"],
  },
  {
    title: "🎬 多媒体创作",
    tags: ["剪映", "无人机", "PR", "PS", "相机"],
  },
]);

// 打字机
const typeTextShow = ref("");
const typeText =
  " 拥有 3 年企业级前端开发经验,深耕 ToB 工业数字化领域，擅长前端页面开发、数据可视化、3D 交互场景搭建与跨端应用开发。\n 日常热爱视觉创作、视频拍摄剪辑与内容创作，兼具技术实力与审美能力，做事踏实细心，学习能力强，乐于持续深耕技术，追求高效优质的开发体验，期待与更多行业伙伴交流成长。";
let charIndex = 0;

// 打字机
const typeWriter = () => {
  if (charIndex < typeText.length) {
    typeTextShow.value += typeText.charAt(charIndex);
    charIndex++;
